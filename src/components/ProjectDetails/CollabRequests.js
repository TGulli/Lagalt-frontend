...
function CollabRequests(props) {
    ...
    const handleApproveDecline = (collaborator, status) => {
        ...
        const requestOptions = {
            ...
            body: JSON.stringify({user: {id: owner.id}, projectCollaborators: {id: collaborator.id, status: status, user: { id: collaborator.user.id }, project: {id: collaborator.project}}})
        };
